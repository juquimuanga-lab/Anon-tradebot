...
GRADUATION_HUNTER_MAX_OBSERVATION_SECONDS = 120.0
GRADUATION_HUNTER_MIN_REAL_SOL = 10.0
GRADUATION_HUNTER_MAX_REAL_SOL = 35.0
GRADUATION_HUNTER_TARGET_REAL_SOL = 85.0
GRADUATION_HUNTER_MIN_BUY_SELL_RATIO = 3.0
GRADUATION_HUNTER_MIN_UNIQUE_BUYERS = 20
GRADUATION_HUNTER_MIN_BUYER_DIVERSITY = 0.35
GRADUATION_HUNTER_MAX_TOP10_SHARE = 0.60
GRADUATION_HUNTER_MIN_HOLDER_GROWTH_PER_MIN = 10.0
GRADUATION_HUNTER_SCORE_THRESHOLD = 75.0
...
class ScannerService:
    ...
    def _graduation_hunter_gate(token, rule_params) -> tuple[str, float, list[str], dict]:
        ...
        max_age = float(getattr(rule_params, "graduation_hunter_max_observation_seconds", GRADUATION_HUNTER_MAX_OBSERVATION_SECONDS) or GRADUATION_HUNTER_MAX_OBSERVATION_SECONDS)
