...
async def set_bot_commands(application: Application) -> None:
    ...
    commands = [
        ...
        BotCommand("dopplerstatus", "Show Doppler/SPCX readiness"), BotCommand("enable_doppler", "Enable Doppler/SPCX sniper"), BotCommand("disable_doppler", "Disable Doppler/SPCX sniper"),
...
def build_application() -> Application:
    ...
    application.add_handler(CommandHandler("dopplerstatus", handlers_doppler.dopplerstatus_cmd)); application.add_handler(CommandHandler("enable_doppler", handlers_doppler.enable_doppler_cmd)); application.add_handler(CommandHandler("disable_doppler", handlers_doppler.disable_doppler_cmd)); application.add_handler(CommandHandler("setdopplersize", handlers_doppler.set_doppler_size_cmd)); application.add_handler(CommandHandler("approvespcx", handlers_doppler.approve_spcx_cmd))
