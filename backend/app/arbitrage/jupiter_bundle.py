...
async def _load_lookup_tables(
    ...
    Some deployed solana-py versions do not expose AsyncClient's
    get_address_lookup_table method. Use the standard Solana getAccountInfo
    RPC method and solders' native ALT deserializer instead.
    """
